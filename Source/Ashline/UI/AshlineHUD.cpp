...
void AAshlineHUD::DrawFrontend(AAshlineGameMode* GameMode, UAshlineSaveGame* Save)
{
	...
	DrawTextLine(TEXT("Console: AshUnlockAll  AshPCUltra  AshPCHigh  AshPCPerf  AshSteamDeck  AshGfxCycle  AshGfxAuto"), 48.f, Canvas->SizeY - 24.f, FLinearColor(0.45f, 0.5f, 0.45f));
}
