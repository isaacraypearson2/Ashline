...
def main() -> None:
    ...
    weapons_json = {
        ...
        "gunfeel": {
            ...
            "ammoTypes": ["FMJ", "AP", "HP", "Tracer", "Slug", "Buckshot", "HE", "Subsonic", "Match"],
    ...
    bindings = {
        ...
        "hero": {
            ...
            "masters": {
                ...
                "weaponClassMI": "/Game/Ashline/Materials/PBR/MI_WPN_{Slug}.MI_WPN_{Slug}",
                "skinMI": "/Game/Ashline/Materials/PBR/MI_SkinMaster.MI_SkinMaster",
                "characterMI": "/Game/Ashline/Materials/PBR/MI_CharacterMaster.MI_CharacterMaster",
            },
        },
