...
/**
 * Canonical master graphs authored in-editor by Scripts/create_master_materials.py.
...
{
	Environment UMETA(DisplayName = "M_Env_Master"),
	Weapon UMETA(DisplayName = "M_Weapon_Master"),
	Character UMETA(DisplayName = "M_Character_Master"),
	Decal UMETA(DisplayName = "M_Decal_Master"),
	Glass UMETA(DisplayName = "M_Glass_Master"),
	Skin UMETA(DisplayName = "M_Skin_Master")
};
